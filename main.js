...
/*!*******************************************************!*\
  !*** ./src/shared/service-proxies/service-proxies.ts ***!
  \*******************************************************/
/*! exports provided: API_BASE_URL, AccountServiceProxy, AdditionalDetailServicesServiceProxy, BorrowerEploymentInformationServicesServiceProxy, BorrowerMonthlyIncomeServicesServiceProxy, ConfigurationServiceProxy, CreditAuthAgreementServiceServiceProxy, DeclarationServiceServiceProxy, EConsentServiceServiceProxy, EmploymentIncomeServiceServiceProxy, ExpenseServicesServiceProxy, LoanServiceProxy, LoanDetailServicesServiceProxy, PersonalDetailServicesServiceProxy, RoleServiceProxy, SessionServiceProxy, TenantServiceProxy, TokenAuthServiceProxy, UniformResidentialLoanServiceProxy, UserServiceProxy, IsTenantAvailableInput, TenantAvailabilityState, IsTenantAvailableOutput, RegisterInput, RegisterOutput, AdditionalDetailsDto, AdditionalDetailsDtoPagedResultDto, BorrowerEmploymentInformationDto, BorrowerEmploymentInformationDtoPagedResultDto, BorrowerMonthlyIncomeDto, BorrowerMonthlyIncomeDtoPagedResultDto, ChangeUiThemeInput, CreditAuthAgreementDto, CreditAuthAgreementDtoPagedResultDto, DeclarationDto, DeclarationDtoPagedResultDto, DeclarationBorrowereDemographicsInformationDto, EConsentDto, EConsentDtoPagedResultDto, EmploymentIncomeDto, EmploymentIncomeDtoPagedResultDto, ExpensesDto, ExpensesDtoPagedResultDto, LoanDetailDto, Borrower, PersonalInformationDto, LoanApplicationDto, LoanApplicationDtoPagedResultDto, LoanDetailDtoPagedResultDto, PersonalInformationDtoPagedResultDto, CreateRoleDto, RoleDto, RoleListDto, RoleListDtoListResultDto, PermissionDto, PermissionDtoListResultDto, RoleEditDto, FlatPermissionDto, GetRoleForEditOutput, RoleDtoPagedResultDto, ApplicationInfoDto, UserLoginInfoDto, TenantLoginInfoDto, GetCurrentLoginInformationsOutput, CreateTenantDto, TenantDto, TenantDtoPagedResultDto, AuthenticateModel, AuthenticateResultModel, ExternalLoginProviderInfoModel, ExternalAuthenticateModel, ExternalAuthenticateResultModel, CreateUserDto, UserDto, RoleDtoListResultDto, ChangeUserLanguageDto, ChangePasswordDto, ResetPasswordDto, UserDtoPagedResultDto, ApiException */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BorrowerEploymentInformationServicesServiceProxy", function() { return BorrowerEploymentInformationServicesServiceProxy; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UniformResidentialLoanServiceProxy", function() { return UniformResidentialLoanServiceProxy; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeclarationBorrowereDemographicsInformationDto", function() { return DeclarationBorrowereDemographicsInformationDto; });
...
class BorrowerEploymentInformationServicesServiceProxy {
    constructor(http, baseUrl) {
        this.jsonParseReviver = undefined;
        this.http = http;
        this.baseUrl = baseUrl ? baseUrl : "";
    ...
    get(id) {
        let url_ = this.baseUrl +
            "/api/services/app/BorrowerEploymentInformationServices/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    getAll(keyword, skipCount, maxResultCount) {
        let url_ = this.baseUrl +
            "/api/services/app/BorrowerEploymentInformationServices/GetAll?";
        if (keyword !== undefined && keyword !== null)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
    ...
    create(body) {
        let url_ = this.baseUrl +
            "/api/services/app/BorrowerEploymentInformationServices/Create";
        url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(body);
        let options_ = {
            body: content_,
    ...
    update(body) {
        let url_ = this.baseUrl +
            "/api/services/app/BorrowerEploymentInformationServices/Update";
        url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(body);
        let options_ = {
            body: content_,
    ...
    delete(id) {
        let url_ = this.baseUrl +
            "/api/services/app/BorrowerEploymentInformationServices/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
BorrowerEploymentInformationServicesServiceProxy.ɵfac = function BorrowerEploymentInformationServicesServiceProxy_Factory(t) { return new (t || BorrowerEploymentInformationServicesServiceProxy)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](API_BASE_URL, 8)); };
BorrowerEploymentInformationServicesServiceProxy.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: BorrowerEploymentInformationServicesServiceProxy, factory: BorrowerEploymentInformationServicesServiceProxy.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](BorrowerEploymentInformationServicesServiceProxy, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], decorators: [{
                type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"],
                args: [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]]
...
class DeclarationServiceServiceProxy {
     ...
     * @return Success
     */
    createDeclarationBorrowereDemographicsInformation(body) {
        let url_ = this.baseUrl +
            "/api/services/app/DeclarationService/CreateDeclarationBorrowereDemographicsInformation";
        url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(body);
        let options_ = {
            body: content_,
    ...
    processCreateDeclarationBorrowereDemographicsInformation(response) {
        const status = response.status;
        const responseBlob = response instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpResponse"]
            ? response.body
            : response.error instanceof Blob
...
class UniformResidentialLoanServiceProxy {
    constructor(http, baseUrl) {
        this.jsonParseReviver = undefined;
        this.http = http;
        this.baseUrl = baseUrl ? baseUrl : "";
...
UniformResidentialLoanServiceProxy.ɵfac = function UniformResidentialLoanServiceProxy_Factory(t) { return new (t || UniformResidentialLoanServiceProxy)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](API_BASE_URL, 8)); };
UniformResidentialLoanServiceProxy.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: UniformResidentialLoanServiceProxy, factory: UniformResidentialLoanServiceProxy.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](UniformResidentialLoanServiceProxy, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], decorators: [{
                type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"],
                args: [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]]
...
class BorrowerEmploymentInformationDto {
    ...
    init(_data) {
        if (_data) {
            ...
            this.dateFromTo = _data["dateFromTo"]
                ? moment__WEBPACK_IMPORTED_MODULE_4__(_data["dateFromTo"].toString())
                : undefined;
    ...
    toJSON(data) {
        ...
        data["dateFromTo"] = this.dateFromTo
            ? this.dateFromTo.toISOString()
            : undefined;
...
class DeclarationBorrowereDemographicsInformationDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
    ...
    init(_data) {
        if (_data) {
            ...
            this.isDonotProvideSexInformattion =
                _data["isDonotProvideSexInformattion"];
        }
    }
    static fromJS(data) {
        data = typeof data === "object" ? data : {};
...
class EmploymentIncomeDto {
    ...
    init(_data) {
        if (_data) {
            this.id = _data["id"];
            this.borrowerEmploymentInformations = _data["borrowerEmploymentInformations"]
                ? BorrowerEmploymentInformationDto.fromJS(_data["borrowerEmploymentInformations"])
                : undefined;
            this.coBorrowerEmploymentInformations = _data["coBorrowerEmploymentInformations"]
                ? BorrowerEmploymentInformationDto.fromJS(_data["coBorrowerEmploymentInformations"])
                : undefined;
    ...
    toJSON(data) {
        data = typeof data === "object" ? data : {};
        data["id"] = this.id;
        data["borrowerEmploymentInformations"] = this.borrowerEmploymentInformations
            ? this.borrowerEmploymentInformations.toJSON()
            : undefined;
        data["coBorrowerEmploymentInformations"] = this
            .coBorrowerEmploymentInformations
            ? this.coBorrowerEmploymentInformations.toJSON()
            : undefined;
...
class LoanApplicationDto {
    ...
    init(_data) {
        if (_data) {
            ...
            this.loanDetail = _data["loanDetail"]
                ? LoanDetailDto.fromJS(_data["loanDetail"])
                : undefined;
            ...
            this.creditAuthAgreement = _data["creditAuthAgreement"]
                ? CreditAuthAgreementDto.fromJS(_data["creditAuthAgreement"])
                : undefined;
            ...
            this.declaration = _data["declaration"]
                ...
                : undefined;
            this.declarationBorrowereDemographicsInformation = _data["declarationBorrowereDemographicsInformation"]
                ? DeclarationBorrowereDemographicsInformationDto.fromJS(_data["declarationBorrowereDemographicsInformation"])
                : undefined;
        }
    }
    static fromJS(data) {
    ...
    toJSON(data) {
        ...
        data["declaration"] = this.declaration
            ...
            : undefined;
        data["declarationBorrowereDemographicsInformation"] = this
            .declarationBorrowereDemographicsInformation
            ? this.declarationBorrowereDemographicsInformation.toJSON()
            : undefined;
        return data;
    }
    clone() {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](SharedModule, { declarations: [_components_pagination_abp_pagination_controls_component__WEBPACK_IMPORTED_MODULE_12__["AbpPaginationControlsComponent"],
        ...
        _shared_directives_phone_mask_directive__WEBPACK_IMPORTED_MODULE_20__["PhoneMaskDirective"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_3__["NgxPaginationModule"]], exports: [_components_pagination_abp_pagination_controls_component__WEBPACK_IMPORTED_MODULE_12__["AbpPaginationControlsComponent"],
        _components_validation_abp_validation_summary_component__WEBPACK_IMPORTED_MODULE_13__["AbpValidationSummaryComponent"],
        _components_modal_abp_modal_header_component__WEBPACK_IMPORTED_MODULE_14__["AbpModalHeaderComponent"],
        _components_modal_abp_modal_footer_component__WEBPACK_IMPORTED_MODULE_15__["AbpModalFooterComponent"],
        _shared_pipes_localize_pipe__WEBPACK_IMPORTED_MODULE_8__["LocalizePipe"],
...
module.exports = __webpack_require__(/*! C:\Users\Shabir\source\repos\LoanApplication\angular\src\main.ts */"./src/main.ts");
